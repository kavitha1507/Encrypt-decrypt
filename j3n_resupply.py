...
from BackupScripts.j3n import j3nBackup
...
def templateToMail(record,JID,AID,dataFormat):
	...
	templateFilePath = os.path.realpath(os.path.join(os.path.dirname(__file__),"Templates/{}".format(template['j3n']))) # Change template filename mentioned in configs file
